...
function collectContractFiles(dirPath) {
    const result = [];
...
if (filePaths.length === 0) {
    console.warn("No contracts found; remember to pin deployed contracts in Remix or build them locally, in order to use them from frontend");
    process.exit(1);
}
